...
public class AddEmployeesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelWelcome.setText("Add New Employee");
        ...
        txtFieldEmpId.setEditable(false);
        txtFieldEmpId.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(comboJob, 0, 182, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel2)
                    .addComponent(txtFieldEmpId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpActionPerformed
        ...
        try {
            ...
            emp.setEmpid(txtFieldEmpId.getText());
            ...
            if (EmployeeDAO.addEmployee(emp)) {
                JOptionPane.showMessageDialog(null, "Employee Record Addded Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
                resetInputs();
            } else {
                JOptionPane.showMessageDialog(null, "Error! Employee Record not inserted", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void resetInputs() {
        try {
            txtFieldEmpId.setText(EmployeeDAO.getNextEmpID());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Error while connecting to database", "Database Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
            return;
